...
这个问题不需要使用逆向归纳法的框架就可以解决：首先计算每个阶段的期望收益，假设秘书共有$n$位，我们将每个阶段时已经面试过的人中能力最强者称为“候选人”，那么显然有：

$$y_i = \begin{cases} \dfrac{i}{n}  \quad \text{第}i\text{位面试者是候选人} \\ 0  \quad \text{第}i\text{位面试者不是候选人} \end{cases}$$
