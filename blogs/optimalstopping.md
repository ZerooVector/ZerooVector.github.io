...
在上面的经典问题中，只有选中能力最佳的秘书才有收益。现在，我们给$n$个人的能力赋予从$1$到$n$的排名，排名为$i$的人被选择时带来效用$U(i)$，$U(i)$满足$U(1) \ge U(2) \cdots \ge U(n)$，这个性质被称为效用单调。上面的经典问题可以写为$U(1)=1 ,U(2) = \cdots = U(n) = 0$。
